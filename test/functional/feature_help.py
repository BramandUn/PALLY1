...
"""Verify that starting PALLY1 with -h works as expected."""
import subprocess

from test_framework.test_framework import PALLY1TestFramework
from test_framework.util import assert_equal

class HelpTest(PALLY1TestFramework):
    ...
    def run_test(self):
        self.log.info("Start PALLY1 with -h for help text")
        ...
        self.log.info("Start PALLY1 with -version for version information")
