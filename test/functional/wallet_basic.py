...
class WalletTest(PALLY1TestFramework):
    ...
    def run_test(self):
        ...
        # node0 should end up with 100 PALLY1 in block rewards plus fees, but
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/PALLY1/PALLY1/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
