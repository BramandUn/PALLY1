...
# TestP2PConn: A peer we use to send messages to PALLY1d, and store responses.
...
class CompactBlocksTest(PALLY1TestFramework):
    ...
    # This test actually causes PALLY1d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that PALLY1d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for PALLY1d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # PALLY1d will not send blocktxn responses for blocks whose height is
