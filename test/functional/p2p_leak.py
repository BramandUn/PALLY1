...
Also test that nodes that send unsupported service bits to PALLY1d are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if PALLY1d ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(PALLY1TestFramework):
