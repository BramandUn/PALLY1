...
* PALLY1.conf: contains configuration settings for PALLY1d or PALLY1-qt
* PALLY1d.pid: stores the process id of PALLY1d while running
...
* debug.log: contains debug information and general logging generated by PALLY1d or PALLY1-qt
