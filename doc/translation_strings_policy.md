...
This document provides guidelines for internationalization of the PALLY1 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `PALLY1_en.ts` remains unchanged.
