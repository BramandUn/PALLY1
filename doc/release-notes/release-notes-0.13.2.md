PALLY1 Core version 0.13.2 is now available from:

  <https://PALLY1.org/bin/PALLY1-core-0.13.2/>
...
- #8908 `4a974b2` Update PALLY1-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow PALLY1-tx to create v2 transactions (PALLY1drak)
