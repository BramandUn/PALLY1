PALLY1-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/PALLY1/files/PALLY1/PALLY1-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the PALLY1
...
New/changed settings (command-line or PALLY1.conf file)
--------------------------------------------------------
