PALLY1 Core version 0.9.4 is now available from:

  https://PALLY1.org/bin/0.9.4/
...
this update is incompatible with the PALLY1 system and could lead to consensus
forks.

PALLY1 Core released binaries from https://PALLY1.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~PALLY1/+archive/ubuntu/PALLY1
- A third-party or self-compiled PALLY1 Core

upgrade to PALLY1 Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
