PALLY1 Core version 0.10.4 is now available from:

  <https://PALLY1.org/bin/PALLY1-core-0.10.4/>
...
- #6953 `43c2789` Split PALLY1-tx into its own package
- #6953 `dfe0d4d` Include PALLY1-tx binary on Debian/Ubuntu
