...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/PALLY1/PALLY1/pull/10340, but that change has been
    // postponed until after https://github.com/PALLY1/PALLY1/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign, OnTransactionToBeSigned onTxToBeSigned)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-PALLY1-address
            CScript scriptChange;
 ...
 * https://PALLY1talk.org/?topic=54527, or
 * https://github.com/PALLY1/PALLY1/pull/1393.
 */
