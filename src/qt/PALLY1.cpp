...
{
    return QCoreApplication::translate("PALLY1-core", psz).toStdString();
}
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // PALLY1: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. PALLY1 can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(PALLY1);
    Q_INIT_RESOURCE(PALLY1_locale);
    ...
    // PALLY1: links repeatedly have their payment requests routed to this process:
