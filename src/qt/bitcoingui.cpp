    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = tr("PALLY1 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PALLY1 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PALLY1: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PALLY1 Core"), this);
    aboutAction->setStatusTip(tr("Show information about PALLY1 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PALLY1 Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PALLY1 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PALLY1 addresses"));
    ...
    openAction->setStatusTip(tr("Open a PALLY1: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PALLY1 Core help message to get a list with possible PALLY1 Core command-line options"));
...
void BitcoinGUI::createToolBarWidgets(QToolBar *toolbar)
{
    ...
    std::tie(label, sendCoinsAction) = CreateWidgetHelper("send", tr("Send coins to a PALLY1 address"));

    shortcut = CreateShortcut(Qt::Key_4);

    std::tie(label, receiveCoinsAction) = CreateWidgetHelper("receive", tr("Request payments (generates QR codes and PALLY1: URIs)"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PALLY1 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PALLY1 network", "", count));
    } else {
...
{
    QString strTitle = tr("PALLY1 Core"); // default title
