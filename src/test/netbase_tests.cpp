...
{
    BOOST_CHECK(TestSplitHost("www.PALLY1.org", "www.PALLY1.org", -1));
    BOOST_CHECK(TestSplitHost("[www.PALLY1.org]", "www.PALLY1.org", -1));
    BOOST_CHECK(TestSplitHost("www.PALLY1.org:80", "www.PALLY1.org", 80));
    BOOST_CHECK(TestSplitHost("[www.PALLY1.org]:80", "www.PALLY1.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6883", "127.0.0.1", 6883));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6883", "127.0.0.1", 6883));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6883", "::ffff:127.0.0.1", 6883));
    BOOST_CHECK(TestSplitHost("[::]:6883", "::", 6883));
    BOOST_CHECK(TestSplitHost("::6883", "::6883", -1));
    BOOST_CHECK(TestSplitHost(":6883", "", 6883));
    BOOST_CHECK(TestSplitHost("[]:6883", "", 6883));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6883", "127.0.0.1:6883"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6883", "[::]:6883"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
