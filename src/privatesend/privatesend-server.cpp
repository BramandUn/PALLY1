...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all PALLY1 related functionality
...
/*
    ...
    allow endless transaction that would bloat PALLY1 and make it unusable. To
