...
bool net_processing_PALLY1::ProcessGetData(CNode *pfrom, const Consensus::Params &consensusParams, CConnman *connman, const CInv &inv)
{
...
void net_processing_PALLY1::ProcessExtension(CNode *pfrom, const std::string &strCommand, CDataStream &vRecv, CConnman *connman)
{
...
void net_processing_PALLY1::ThreadProcessExtensions(CConnman *pConnman)
{
...
bool net_processing_PALLY1::AlreadyHave(const CInv &inv)
{
    switch(inv.type)
    {
    /*
    PALLY1 Related Inventory Messages
...
bool net_processing_PALLY1::TransformInvForLegacyVersion(CInv &inv, CNode *pfrom, bool fForSending)
{
